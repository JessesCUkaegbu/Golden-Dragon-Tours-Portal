    ...
    class Meta:
        ...
        widgets = {
            "full_name": forms.TextInput(
                attrs={"class": "form-control custom-input", "placeholder": "Enter full name"}
            ),
            "email": forms.EmailInput(
                attrs={"class": "form-control custom-input", "placeholder": "Enter email"}
            ),
            "phone": forms.TextInput(
                attrs={"class": "form-control custom-input", "placeholder": "Enter phone number"}
            ),
            ...
            "quantity": forms.NumberInput(
                attrs={"class": "form-control custom-input", "min": 1}
            ),
        }
    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control custom-input", "placeholder": "Enter event name"}
            ),
            "event_date": forms.DateInput(
                attrs={"class": "form-control custom-input", "type": "date"}
            ),
            "location": forms.TextInput(
                attrs={"class": "form-control custom-input", "placeholder": "Enter location"}
            ),
            ...
            "ticket_image": forms.ClearableFileInput(
